    ...
    >
      <div className="md:hidden flex justify-end px-4">
        <span
          ...
          className="flex font-medium text-neutral-400 py-1 justify-center items-center"
        >
      ...
      <div ref={componentRef} className="overflow-y-scroll h-[100%] pt-1 px-4">
        <div className="py-2 flex justify-between items-center border-b border-dashed border-neutral-400">
          ...
          <div className="flex justify-between items-center w-[105px] md:w-[300px]">
            ...
            >
              <button
                onClick={() => usePathname()}
                className="group cursor-pointer flex justify-between items-center rounded-md py-2 px-4 text-sm bg-transparent border border-primary-600 text-primary-600 hover:bg-primary-600 hover:text-white"
              >
                <i className="ri-share-fill"></i>
                <p className="hidden lg:block font-bold ml-2 font-gilmer">
                  Share
                </p>
              </button>
            </RWebShare>
            ...
            <ReactToPrint
              trigger={() => (
                <span className="group cursor-pointer flex justify-between items-center rounded-md py-2 px-4 text-sm bg-transparent border border-primary-600 text-primary-600 hover:bg-primary-600 hover:text-white">
        ...
        <small className="flex justify-end text-neutral-400 text-[10px] pb-4">
          Source: National Bureau of Statistics (NLSS 2018 - 2019)
        </small>
      </div>
    </div>
  );
