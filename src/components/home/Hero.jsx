        ...
        <Section className="h-[80%]" style={{backgroundColor: "linear-gradient(180deg, #FFFFFF 0%, rgba(232, 232, 232, 0) 100%)"}}>
            <div className="mx-auto w-11/12 max-w-7xl pt-36 pb-16">
                <div className="flex flex-col justify-center items-center mb-16">
                    <Title className="text-center w-full mb-8 md:max-w-[886px]">Discover amazing data about your country</Title>
                    <SubTitle className="text-neutral-700 text-center w-full md:max-w-[750px]">Explore using our interactive map, important information and data about your nation, region or locality.</SubTitle>
                </div>
