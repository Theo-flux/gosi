                ...
                <div className="py-[2.3em]">
                    ...
                    <div className="flex justify-end items-start pt-4 border-t-[1px] border-neutral-400">
                        ...
                        <div className="flex justify-between items-center w-[160px] md:w-[152px]">
                            <a href="" className="w-[40px] h-[40px] border-[1px] border-neutral-400 rounded-full flex justify-center items-center"><i className="ri-linkedin-fill text-primary-600"></i></a>
                            <a href="https://www.facebook.com/DTInigeria/" className="w-[40px] h-[40px] border-[1px] border-neutral-400 rounded-full flex justify-center items-center"><i className="ri-facebook-fill text-primary-600"></i></a>
                            <a href="https://twitter.com/dtiGlobal" className="w-[40px] h-[40px] border-[1px] border-neutral-400 rounded-full flex justify-center items-center"><i className="ri-twitter-fill text-primary-600"></i></a>
                        </div>
                    </div>
